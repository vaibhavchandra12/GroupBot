...
from GroupBot import BOT_ID
from GroupBot.helper_extra.aichat import add_chat, get_session, remove_chat
from GroupBot.pyrogramee.pluginshelper import admins_only, edit_or_reply
from GroupBot import pbot as innexia
...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("innexia", "Aco")
        URL = "https://api.affiliateplus.xyz/api/chatbot?message=hi&botname=@KabeerGroupBot&ownername=@useIes"
        ...
        test = test.replace("innexia", "Aco")
        test = test.replace("innexia", "Aco")
        URL = f"https://api.affiliateplus.xyz/api/chatbot?message={test}&botname=@KabeerGroupBot&ownername=@useIes"
        try:
            r = requests.request("GET", url=URL)
        except:
            return
